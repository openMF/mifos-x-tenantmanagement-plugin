...
public record TenantUpdateRequest(
     ...
     *
     * <p>Names only - never values. {@code schemaPassword} appears here when a password was
     * rotated, so the rotation is recorded while the password itself never leaves this object.
     *
