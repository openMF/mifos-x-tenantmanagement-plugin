...
public enum TenantStatus {
     ...
     *
     * <p>Matching is case insensitive for the caller's convenience but pinned to {@link
     * Locale#ROOT}, because the tenant's locale must not decide whether a status is recognised:
     * under a Turkish locale the default folding turns the {@code I} of {@code INACTIVE} into a
     * dotless {@code ı}, which would match nothing.
     *
