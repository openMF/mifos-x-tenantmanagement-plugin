                ...
                new OpenAPI()
                        .info(
                                new Info()
                                        ...
                                        .version("1.0")
                                        .description(
                                                "Tenant lifecycle administration provided by the"
                                                    + " Mifos X tenant management plugin (MX-406)."
                                                    + " Served in a master context: authenticate as"
                                                    + " a master user holding the SUPER_MASTER"
                                                    + " role, with no tenant header."))
                        .addServersItem(
                                new Server()
                                        .url("/fineract-provider/api")
                                        .description(
                                                "Apache Fineract with the tenant management plugin"
                                                        + " loaded"))
                        .components(
                                new Components()
                                        .addSecuritySchemes(
